      ...
      <div className="dashboard-grid">
        ...
        <div className="quick-actions-section">
          ...
          <div className="action-cards">
            <Link to="/vendor/add-vehicle" style={{ textDecoration: 'none' }}>
            ...
            <Link to="/vendor/fleet" style={{ textDecoration: 'none' }}>
            ...
            <Link to="/vendor/bookings" style={{ textDecoration: 'none' }}>
            ...
            <Link to="/vendor/earnings" style={{ textDecoration: 'none' }}>
